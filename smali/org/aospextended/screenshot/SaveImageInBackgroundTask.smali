.class Lorg/aospextended/screenshot/SaveImageInBackgroundTask;
...
.field private final mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;
...
# direct methods
.method constructor <init>(Landroid/content/Context;Lorg/aospextended/screenshot/SaveImageInBackgroundData;Landroid/app/NotificationManager;)V
    .locals 23
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "data"    # Lorg/aospextended/screenshot/SaveImageInBackgroundData;
    ...
    iput-object v10, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->viewIntent:Landroid/content/Intent;

    .line 167
    iput-object v10, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->deleteIntent:Landroid/app/PendingIntent;

    .line 168
    iput-object v10, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->uri:Landroid/net/Uri;

    .line 170
    const/4 v0, 0x0

    iput-boolean v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNeedRecycle:Z
    ...
    iput-object v9, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;
    ...
    iput-wide v1, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageTime:J

    .line 188
    iget-wide v1, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageTime:J

    const-wide/16 v3, 0x3e8

    div-long/2addr v1, v3

    sput-wide v1, Lorg/aospextended/screenshot/GlobalScreenshot;->mLastImageTime:J
    ...
    iget-wide v3, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageTime:J
    ...
    iput-object v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFileName:Ljava/lang/String;
    ...
    iput-object v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mScreenshotDir:Ljava/io/File;

    .line 195
    new-instance v0, Ljava/io/File;

    iget-object v1, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mScreenshotDir:Ljava/io/File;

    iget-object v2, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFileName:Ljava/lang/String;
    ...
    iput-object v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFilePath:Ljava/lang/String;

    .line 198
    iget-object v0, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->image:Landroid/graphics/Bitmap;

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v0

    iput v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageWidth:I
    ...
    iput v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageHeight:I

    .line 200
    iget v14, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->iconSize:I

    .line 201
    .local v14, "iconSize":I
    iget v15, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->previewWidth:I

    .line 202
    .local v15, "previewWidth":I
    iget v6, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->previewheight:I

    .line 204
    .local v6, "previewHeight":I
    iget-boolean v0, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->needRecycle:Z
    ...
    iget v0, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageWidth:I
    ...
    iget v1, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageHeight:I
    ...
    .line 222
    iget-object v1, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->image:Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->generateAdjustedHwBitmap(Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Landroid/graphics/Paint;I)Landroid/graphics/Bitmap;
    ...
    iget v1, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageWidth:I

    iget v2, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageHeight:I
    ...
    iget v3, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageHeight:I
    ...
    sget-boolean v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mTickerAddSpace:Z

    xor-int/2addr v1, v13

    sput-boolean v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mTickerAddSpace:Z

    .line 245
    move-object/from16 v1, p3

    iput-object v1, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput-object v4, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationStyle:Landroid/app/Notification$BigPictureStyle;

    .line 253
    new-instance v4, Landroid/app/Notification$Builder;

    sget-object v5, Lorg/aospextended/screenshot/GlobalScreenshot;->SCREENSHOTS:Ljava/lang/String;
    ...
    iput-object v4, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mPublicNotificationBuilder:Landroid/app/Notification$Builder;

    .line 271
    new-instance v4, Landroid/app/Notification$Builder;

    sget-object v13, Lorg/aospextended/screenshot/GlobalScreenshot;->SCREENSHOTS:Ljava/lang/String;
    ...
    .line 274
    sget-boolean v5, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mTickerAddSpace:Z
    ...
    iget-object v5, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationStyle:Landroid/app/Notification$BigPictureStyle;
    ...
    iget-object v5, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mPublicNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iput-object v4, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationBuilder:Landroid/app/Notification$Builder;

    .line 286
    iget-object v4, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    .line 289
    iget-object v4, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationManager:Landroid/app/NotificationManager;

    iget-object v5, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    .line 302
    iget-object v4, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationStyle:Landroid/app/Notification$BigPictureStyle;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->isCancelled()Z
    ...
    .line 335
    iget-object v0, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v4, v0, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->context:Landroid/content/Context;

    .line 336
    .local v4, "context":Landroid/content/Context;
    iget-object v0, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v5, v0, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->image:Landroid/graphics/Bitmap;
    ...
    :try_start_0
    iget-object v0, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mScreenshotDir:Ljava/io/File;

    invoke-virtual {v0}, Ljava/io/File;->mkdirs()Z

    .line 355
    iget-wide v9, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageTime:J
    ...
    iget-object v11, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFilePath:Ljava/lang/String;
    ...
    .line 365
    sget-boolean v0, Lorg/aospextended/screenshot/longshot/util/Configs;->IS_ENCRYPT_IMAGE:Z
    ...
    .line 367
    iget-object v0, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFilePath:Ljava/lang/String;
    ...
    .line 373
    sget-object v0, Lorg/aospextended/screenshot/longshot/util/Configs;->IMEI_NUMBER:Ljava/lang/String;
    ...
    invoke-static {v0, v7, v2}, Lorg/aospextended/screenshot/Native;->doencrypt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v2, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mScreenshotDir:Ljava/io/File;

    iget-object v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFileName:Ljava/lang/String;
    ...
    iput-object v2, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFileName:Ljava/lang/String;
    ...
    iput-object v2, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFilePath:Ljava/lang/String;
    ...
    iget-object v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFilePath:Ljava/lang/String;
    ...
    iget-wide v13, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageTime:J
    ...
    iget v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageWidth:I
    ...
    iget v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageHeight:I
    ...
    iget-object v13, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageFilePath:Ljava/lang/String;
    ...
    iget-wide v14, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mImageTime:J
    ...
    const-class v0, Lorg/aospextended/screenshot/GlobalScreenshot$TargetChosenReceiver;
    ...
    iget-object v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    invoke-static {v7, v4}, Lorg/aospextended/screenshot/EditActionInjector;->getAction(Landroid/net/Uri;Landroid/content/Context;)Landroid/app/Notification$Action;
    ...
    const-class v15, Lorg/aospextended/screenshot/GlobalScreenshot$DeleteScreenshotReceiver;
    ...
    .line 464
    iget-object v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iput-object v7, v8, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->imageUri:Landroid/net/Uri;
    ...
    iput-object v15, v8, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->image:Landroid/graphics/Bitmap;
    ...
    iput v15, v8, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->errorMsgResId:I

    .line 469
    iput-object v2, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->viewIntent:Landroid/content/Intent;

    .line 470
    iput-object v0, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->deleteIntent:Landroid/app/PendingIntent;

    .line 472
    iget-object v8, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v8, v8, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->handler:Landroid/os/Handler;
    :try_end_4
    ...
    .local v0, "e":Ljava/lang/Exception;
    :goto_3
    iget-object v2, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    invoke-virtual {v2}, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->clearImage()V
    ...
    iput v3, v2, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->errorMsgResId:I
    ...
    iget-boolean v3, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNeedRecycle:Z
    ...
    sget-boolean v3, Lorg/aospextended/screenshot/GlobalScreenshot;->mIsBusy:Z
    ...
    iget-boolean v0, v1, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNeedRecycle:Z
    ...
    invoke-virtual {v0}, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->doDelayAction()V
...
.method public getDeleteIntent()Landroid/app/PendingIntent;
    ...
    .line 573
    iget-object v0, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->deleteIntent:Landroid/app/PendingIntent;
...
.method public getImageUri()Landroid/net/Uri;
    ...
    .line 577
    iget-object v0, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v0, v0, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->imageUri:Landroid/net/Uri;
...
.method public getViewIntent()Landroid/content/Intent;
    ...
    .line 569
    iget-object v0, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->viewIntent:Landroid/content/Intent;
...
.method protected bridge synthetic onCancelled(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->onCancelled(Ljava/lang/Void;)V
...
.method protected onCancelled(Ljava/lang/Void;)V
    ...
    iget-object v0, v0, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->finisher:Ljava/lang/Runnable;
    ...
    invoke-virtual {v0}, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->clearImage()V

    .line 561
    iget-object v0, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    invoke-virtual {v0}, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->clearContext()V

    .line 564
    iget-object v0, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationManager:Landroid/app/NotificationManager;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->onPostExecute(Ljava/lang/Void;)V
...
.method protected onPostExecute(Ljava/lang/Void;)V
    ...
    iget-object v2, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget v2, v2, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->errorMsgResId:I
    ...
    iget v0, v0, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->errorMsgResId:I
    ...
    iget-object v0, v0, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->context:Landroid/content/Context;

    iget-object v1, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iget-object v3, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v3, v3, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->imageUri:Landroid/net/Uri;
    ...
    .line 526
    .local v5, "now":J
    iget-object v3, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mPublicNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iget-object v9, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v9, v9, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->context:Landroid/content/Context;
    ...
    .line 534
    iget-object v3, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iget-object v7, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mParams:Lorg/aospextended/screenshot/SaveImageInBackgroundData;

    iget-object v7, v7, Lorg/aospextended/screenshot/SaveImageInBackgroundData;->context:Landroid/content/Context;
    ...
    iget-object v7, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mPublicNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    .line 545
    iget-object v3, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationManager:Landroid/app/NotificationManager;

    iget-object v7, p0, Lorg/aospextended/screenshot/SaveImageInBackgroundTask;->mNotificationBuilder:Landroid/app/Notification$Builder;
